...
- `concepts/build-stall-watchdog.md` — #24 diagnosis: live-stream stall watchdog + adaptive KV-poll resume (shipped PR #97)
- `concepts/flight-resolver-gaps.md` — #12 follow-up: two coverage gaps in the flight-number / flight-times resolver, with production API probe data and the authorized fix shape
- `learnings/2026-06-27.md` — full work log for the day PRs #64–#69 shipped
- `learnings/2026-06-30.md` — work log for PRs #95–#102 (the 16/23 → 21/24 wave) and the flight-resolver re-grounding
