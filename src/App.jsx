...
• Each day's items[] needs at least 3 items — a typical full day is: morning Activity, afternoon/evening Activity, evening Dinner. Arrival/departure days also include Flight + Hotel. PACE DEFAULTS: "Relaxed" = 1 Activity per full day. "Moderate" or no pace specified = 2 Activity items per full day (one morning, one afternoon). "Full" = 3 Activity items per full day. Marquee sights count toward the day's activity limit — do NOT add extra activities on top of marquee sights. Arrival and departure days always have 0–1 Activity items regardless of pace.
...
Travelers: ${basics.travelers}
Style: ${prefToText(basics.style)} · Pace: ${basics.pace || "Moderate (2 activities/day) — traveler did not specify, use this default"} · Budget: ${prefToText(basics.budget)}
