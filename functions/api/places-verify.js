...
//
// Moved to src/nameMatch.js so the client-side merge can apply the same
// comparison without importing this endpoint (see the import at the top
// of this file). Re-exported here because tests and other Functions
// import these names from this module.
export { normalizeNameForCompare, diceCoefficient, isSimilarEnough };
